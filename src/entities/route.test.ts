...
describe('RouteV2', () => {
  ...
  describe('path', () => {
    it('wraps original v2 route object and successfully constructs a path from the tokens', () => {
  ...
  describe('#midPrice', () => {
    ...
    it('correct for 0 -> 1', () => {
      const routeOriginal = new V2RouteSDK([pool_0_1], token0, token1)
      const price = new RouteV2(routeOriginal).midPrice
    ...
    it('correct for 1 -> 0', () => {
      const routeOriginal = new V2RouteSDK([pool_0_1], token1, token0)
      const price = new RouteV2(routeOriginal).midPrice
    ...
    it('correct for 0 -> 1 -> 2', () => {
      const routeOriginal = new V2RouteSDK([pool_0_1, pool_1_2], token0, token2)
      const price = new RouteV2(routeOriginal).midPrice
    ...
    it('correct for 2 -> 1 -> 0', () => {
      const routeOriginal = new V2RouteSDK([pool_1_2, pool_0_1], token2, token0)
      const price = new RouteV2(routeOriginal).midPrice
    ...
    it('correct for 1 -> weth', () => {
      const price = new V2RouteSDK([pool_1_weth], token1, weth).midPrice
    ...
    it('correct for ether -> 0 -> 1 -> weth', () => {
      const routeOriginal = new V2RouteSDK([pool_0_weth, pool_0_1, pool_1_weth], ETHER, weth)
      const price = new RouteV2(routeOriginal).midPrice
    ...
    it('correct for weth -> 0 -> 1 -> ether', () => {
      const routeOriginal = new V2RouteSDK([pool_0_weth, pool_0_1, pool_1_weth], weth, ETHER)
      const price = new RouteV2(routeOriginal).midPrice
      expect(price.toSignificant(4)).toEqual('0.009524')
