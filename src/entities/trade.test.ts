...
describe('Trade', () => {
  ...
  describe('#fromRoute', () => {
    ...
    it('can contain only a v1 route', async () => {
    ...
    it('can be constructed with ETHER as input for a V1 Route exact input swap', async () => {
      const routeOriginal = new V1RouteSDK([pair_weth_2], ETHER, token2)
      const route = new RouteV1(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(ETHER, JSBI.BigInt(10))
    ...
    it('can be constructed with ETHER as input for a V1 Route exact output swap', async () => {
      const routeOriginal = new V1RouteSDK([pair_weth_2], ETHER, token2)
      const route = new RouteV1(routeOriginal)
    ...
    it('can be constructed with ETHER as output for a V1 Route exact output swap', async () => {
      const routeOriginal = new V1RouteSDK([pair_weth_2], token2, ETHER)
      const route = new RouteV1(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(ETHER, JSBI.BigInt(100))
    ...
    it('can be constructed with ETHER as output for a V1 Route exact input swap', async () => {
      const routeOriginal = new V1RouteSDK([pair_weth_2], token2, ETHER)
      const route = new RouteV1(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(token2, JSBI.BigInt(100))
    ...
    it('throws if input currency does not match for V1 Route', async () => {
      const routeOriginal = new V1RouteSDK([pair_weth_2], token2, ETHER)
      const route = new RouteV1(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
    ...
    it('throws if output currency does not match for V1 Route', async () => {
      const routeOriginal = new V1RouteSDK([pair_0_1], token0, token1)
      const route = new RouteV1(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
  ...
  describe('#fromRoutes', () => {
    ...
    it('can contain muliptle v1 and v3 routes', async () => {
      ...
      const route2OriginalV1 = new V1RouteSDK([pair_weth_0, pair_weth_2], token0, token2)
    ...
    it('can be constructed with ETHER as input for exact input', async () => {
      const routeOriginalV1 = new V1RouteSDK([pair_weth_0, pair_0_1], ETHER, token1)
      const routev1 = new RouteV1(routeOriginalV1)
    ...
    it('can be constructed with ETHER as output for exact output swap', async () => {
      const routeOriginalV1 = new V1RouteSDK([pair_0_1, pair_weth_0], token1, ETHER)
      const routev1 = new RouteV1(routeOriginalV1)
      const amountv1 = CurrencyAmount.fromRawAmount(ETHER, JSBI.BigInt(100))
    ...
    it('throws if pools are re-used between V1 routes', async () => {
      const routeOriginalV1 = new V1RouteSDK([pair_0_1, pair_1_2], token0, token2)
      const routev1 = new RouteV1(routeOriginalV1)
      const amountv1 = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))

      const route2OriginalV1 = new V1RouteSDK([pair_0_1, pair_weth_1, pair_weth_2], token0, token2)
      const route2v1 = new RouteV1(route2OriginalV1)
    ...
    it('throws if pools are re-used between mixed routes and v1 routes', async () => {
      const routeOriginalV1 = new V1RouteSDK([pair_0_1, pair_1_2], token0, token2)
      const routev1 = new RouteV1(routeOriginalV1)
      const amountv1 = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
    ...
    it('throws if routes have different inputs', async () => {
      const routeOriginalV1 = new V1RouteSDK([pair_1_2], token1, token2)
      const routev1 = new RouteV1(routeOriginalV1)
      const amountv1 = CurrencyAmount.fromRawAmount(token1, JSBI.BigInt(100))
    ...
    it('throws if routes have different inputs mixedRoute', async () => {
      ...
      await expect(
        Trade.fromRoutes([{ routev1, amount: amountv1 }], [], TradeType.EXACT_INPUT, [
          { mixedRoute, amount: amountMixedRoute },
        ])
      ).rejects.toThrow('INPUT_CURRENCY_MATCH')
    })
    ...
    it('throws if routes have different outputs', async () => {
      const routeOriginalV1 = new V1RouteSDK([pair_0_1], token0, token1)
      const routev1 = new RouteV1(routeOriginalV1)
      const amountv1 = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
    ...
    it('throws if trade is created with EXACT_OUTPUT and contains mixedRoutes', async () => {
      ...
      await expect(
        Trade.fromRoutes([{ routev1, amount: amountv1 }], [], TradeType.EXACT_OUTPUT, [
