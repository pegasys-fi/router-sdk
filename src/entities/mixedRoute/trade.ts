...
import { BestTradeOptions, Pool } from '@pollum-io/v3-sdk'
 ...
 * @notice This class is functionally the same as the `Trade` class in the `@pollum-io/v3-sdk` package, aside from typing and some input validation.
 * @template TInput The input token, either Ether or an ERC-20
 * @template TOutput The output token, either Ether or an ERC-20
 * @template TTradeType The trade type, either exact input or exact output
 */
