...
import { encodeSqrtRatioX96, FeeAmount, Pool } from '@pollum-io/v2-sdk'
...
describe('#encodeMixedRouteToPath', () => {
  ...
  const route_0_V2_1 = new MixedRouteSDK([pool_0_1_medium], token0, token1)
  const route_0_V2_1_V2_2 = new MixedRouteSDK([pool_0_1_medium, pool_1_2_low], token0, token2)
  const route_0_V2_weth = new MixedRouteSDK([pool_0_weth], token0, ETHER)
  const route_0_V2_1_V2_weth = new MixedRouteSDK([pool_0_1_medium, pool_1_weth], token0, ETHER)
  const route_weth_V2_0 = new MixedRouteSDK([pool_0_weth], ETHER, token0)
  const route_weth_V2_0_V2_1 = new MixedRouteSDK([pool_0_weth, pool_0_1_medium], ETHER, token1)
  ...
  const route_0_V2_1_V1_weth = new MixedRouteSDK([pool_0_1_medium, pair_1_weth], token0, ETHER)
  const route_0_V2_weth_V1_1_V1_2 = new MixedRouteSDK([pool_0_weth, pair_1_weth, pair_1_2], token0, token2)
  const route_0_V2_1_v2_weth_V1_2 = new MixedRouteSDK([pool_0_1_medium, pool_1_weth, pair_2_weth], token0, token2)
  ...
  describe('mixed route', () => {
    it('packs them for exact input v2 -> v1 with wrapped ether output', () => {
      expect(encodeMixedRouteToPath(route_0_V2_1_V1_weth)).toEqual(
    ...
    it('packs them for exact input v2 -> v1 -> v1', () => {
      expect(encodeMixedRouteToPath(route_0_V2_weth_V1_1_V1_2)).toEqual(
    ...
    it('packs them for exact input v2 -> v2 -> v1', () => {
      expect(encodeMixedRouteToPath(route_0_V2_1_v2_weth_V1_2)).toEqual(
