...
describe('SwapRouter', () => {
  ...
  describe('#swapCallParameters', () => {
    describe('single-hop exact input (v1 + v2)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const v2Trade = V2Trade.fromRoute(new V2Route([pool_0_1], token0, token1), amountIn, TradeType.EXACT_INPUT)

        it('array of trades', async () => {
          const trades = [v1Trade, await v2Trade]
        ...
        it('meta-trade', async () => {
          const trades = await Trade.fromRoutes(
            ...
            [
              {
                routev2: (await v2Trade).swaps[0].route,
                amount: amountIn,
              },
            ],
    ...
    describe('single-hop exact output (v1 + v2)', () => {
      describe('different trade configurations result in identical calldata', () => {
        const expectedCalldata =
        ...
        const v2Trade = V2Trade.fromRoute(new V2Route([pool_0_1], token0, token1), amountOut, TradeType.EXACT_OUTPUT)
    ...
    describe('multi-hop exact input (v1 + v2)', () => {
      describe('different trade configurations result in identical calldata', () => {
        const expectedCalldata =
        ...
        const v2Trade = V2Trade.fromRoute(
          new V2Route([pool_0_1, pool_1_WETH], token0, WETH),
          amountIn,
          TradeType.EXACT_INPUT
        )
    ...
    describe('multi-hop exact output (v1 + v2)', () => {
      describe('different trade configurations result in identical calldata', () => {
        const expectedCalldata =
    ...
    describe('Mixed Route', () => {
      describe('single-hop exact input (v1 + v2) backwards compatible', () => {
        describe('different trade configurations result in identical calldata', () => {
          const expectedCalldata =
            ''
          const amountIn = CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100))
    ...
    describe('ETH input', () => {
      describe('single-hop exact input (v1 + v2)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.fromRoute(new V2Route([pool_1_WETH], ETHER, token1), amountIn, TradeType.EXACT_INPUT)
          /// mixedRouteTrade mirrors the V2Trade
      ...
      describe('single-hop exact output (v1 + v2)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.fromRoute(
            new V2Route([pool_1_WETH], ETHER, token1),
            amountOut,
            TradeType.EXACT_OUTPUT
          )
      ...
      describe('multi-hop exact input (v1 + v2)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.fromRoute(
            new V2Route([pool_1_WETH, pool_0_1], ETHER, token0),
            amountIn,
            TradeType.EXACT_INPUT
          )
          ...
          it('mixedRoutes in array produce same calldata', async () => {
            const trades = [await mixedRouteTrade, await v2Trade]
            const { calldata, value } = SwapRouter.swapCallParameters(trades, {
              slippageTolerance,
              recipient,
              deadlineOrPreviousBlockhash: deadline,
          ...
          it('meta-trade with mixedRoutes produces calldata in different order but same content', async () => {
            /// @dev since we order the calldata in the array in a particular way (v1, v2, mixedRoute) the ordering will be different, but the encoded swap data will be the same
      ...
      describe('high price impact with ETH input to result in refundETH being appended to calldata', () => {
        ...
        const v1Trade = V1Trade.exactIn(new V1Route([pair_1_WETH], ETHER, token1), amountIn)
        const v2Trade = V2Trade.fromRoute(
          new V2Route([pool_1_WETH_slippage], ETHER, token1),
          amountIn,
          TradeType.EXACT_INPUT
        )
      ...
      describe('high price impact with ERCO20 input does not result in refundETH call', () => {
        ...
        const v2Trade = V2Trade.fromRoute(
          new V2Route([pool_1_WETH_slippage], token1, WETH),
          amountIn,
          TradeType.EXACT_INPUT
        )
    ...
    describe('ETH output', () => {
      describe('single-hop exact input (v1 + v2)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.fromRoute(new V2Route([pool_1_WETH], token1, ETHER), amountIn, TradeType.EXACT_INPUT)
          /// mixedRoute mirrors v2Trade
          const mixedRouteTrade = MixedRouteTrade.fromRoute(
      ...
      describe('single-hop exact output (v1 + v2)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.fromRoute(
            new V2Route([pool_1_WETH], token1, ETHER),
            amountOut,
            TradeType.EXACT_OUTPUT
          )
      ...
      describe('multi-hop exact input (v1 + v2)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const v2Trade = V2Trade.fromRoute(
            new V2Route([pool_0_1, pool_1_WETH], token0, ETHER),
            amountIn,
            TradeType.EXACT_INPUT
          )
    ...
    describe('#swapAndAddCallParameters', () => {
      describe('single-hop trades', () => {
        ...
        it('correctly encodes the entire swap process when mixedRoute + v2', async () => {
          const trades = [await mixedRouteTrade2, await v2Trade]
          const methodParameters = SwapRouter.swapAndAddCallParameters(
            trades,
            { slippageTolerance },
            position,
      ...
      describe('multi-hop trades', () => {
        ...
        it('encodes the entire swap process for a multi route trade with mixedRoute, v2', async () => {
          const trades = [await mixedRouteTrade2, await v2Trade]
          const methodParameters = SwapRouter.swapAndAddCallParameters(
            trades,
            { slippageTolerance },
      ...
      describe('adding liquidity to an existing position', () => {
        ...
        it('correctly encodes the entire swap process, mixed, v2', async () => {
          const trades = [await mixedRouteTrade2, await v2Trade]
          const methodParameters = SwapRouter.swapAndAddCallParameters(
            trades,
            { slippageTolerance },
      ...
      describe('when input is native', () => {
        ...
        const v2Trade = V2Trade.fromRoute(new V2Route([pool_1_WETH], ETH, token1), amountIn, TradeType.EXACT_INPUT)
        const mixedRouteTrade3 = MixedRouteTrade.fromRoute(
      ...
      describe('when output is native', () => {
        ...
        const v2Trade = V2Trade.fromRoute(new V2Route([pool_1_WETH], token1, ETH), amountIn, TradeType.EXACT_INPUT)
        const mixedRouteTrade3 = MixedRouteTrade.fromRoute(
